                        ...
                        <Slider {...settings}>
                            {
                                costumers.map((item, i) => {
                                    return (
                                        <div key={i} className=" duration-500 mdmax:max-w-[90%] mdmax:ml-[5%] max-w-[200px] external:max-w-[300px] external:ml-10 lgmin:ml-5 min-h-[210px] bg-white snap-center rounded-lg">
