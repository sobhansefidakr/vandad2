    ...
    return (
        <div className="equipments w-full h-full flex justify-center">
            <div className="equipments-container w-full h-full flex items-center justify-evenly max-w-[1300px] py-5">
                ...
                <div className="equipment-slider w-[70%]">
                    <Slider {...settings}>
                        {
                            costumers.map((item, i) => {
                                return (
                                    <div className=" duration-500 mdmax:max-w-[90%] mdmax:ml-[5%] max-w-[250px] external:ml-10 lgmin:ml-5 min-h-[350px] bg-white snap-center rounded-lg shadow-lg">
